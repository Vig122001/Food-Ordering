...
export default function Filter() {
  ...
  useEffect(() => {
    fetch(`/zomato/restaurants`, { method: 'GET' })
  ...
  //call API
  useEffect(() => {
    fetch(`http://localhost:7878/zomato/restaurants/filter/${currentPage}`, {
      method: 'POST',
  ...
  const locationsChange = (e) => {
    const item = e.target.options.selectedIndex;
    filter.city_id = item;
    setFilter({ ...filter });
  };
              ...
              <div id="demo" className="collapse show">
                ...
                <div>
                  <input
                    type="radio"
                    name="cost"
                    onChange={() => handleCostChange(2000, 10000)}
                  />
                ...
                <div>
                  <input
                    type="radio"
                    name="cost"
                    onChange={() => handleCostChange(1, 10000)}
                  />
                  ...
                  <div className="Item">
                    <div className="row pl-1">
                      <div className="col-sm-4 col-md-4 col-lg-4">
                        <img alt="" className="img" src={item.thumb} />
                      </div>
                      <div className="col-sm-8 col-md-8 col-lg-8">
                        <div className="rest-name hyperlink">{item.name}</div>
                        <div className="res-location hyperlink">
                          {item.locality}
                        </div>
                        <div className="rest-address hyperlink">
                          {item.city_name}
                        </div>
                      </div>
                    </div>
